...
cookbook 'consul', git: 'https://github.com/johnbellone/consul-cookbook.git'
cookbook 'docker', git: 'https://github.com/darron/docker-cookbook.git'
cookbook 'openresty', git: 'https://github.com/darron/openresty-cookbook.git'
...
cookbook 'ruby2', git: 'https://github.com/darron/ruby2-cookbook.git'
